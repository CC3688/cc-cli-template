...
const app = ref()
const scrollPane = ref<{ moveToTarget: (tag: HTMLAnchorElement) => void }>()
...
const moveToCurrentTag = () => {
  nextTick(() => {
    const tags = document.querySelectorAll<HTMLAnchorElement>('.tags-view-item')
    for (const tag of Array.from(tags)) {
      if (Array.from(tag.classList).includes('router-link-exact-active')) {
        if (scrollPane.value) {
...
<template>
  <div id="tags-view-container" ref="box" class="tags-view-container">
